                        ...
                        Row(
                          children: [
                            ...
                            Text("Marcos :",
                              ...
                              Expanded(
                                child: Text(" Say goodbye to Oz and everything you own California dreamin' is a Pettibon LA's screaming you're my home Vanity is blasted but it's rarely fair I could smell the Prozac in your pretty hair Got a lot of friends, but is anyone there", 
                        ...
                        Row(
                          children: [
                            ...
                            Text("Roberto :",
                              style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold),), 
                            Expanded(
                                child: Text(" Oruglho da Corporação! Pra cima deles", 
                               style: TextStyle(fontSize: 16),
                               textAlign: TextAlign.justify,
                                )),
                          ],
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Text("Ricardo :",
                              style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold),), 
                            Text(" Bota moral nesses caras! Tamo junto irmão!", style: TextStyle(fontSize: 16),),
                          ],
